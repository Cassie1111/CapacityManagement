sap.ui.jsview("capacity_management.CapacityManagementView", {
	...
	*/ 
	getControllerName : function() {
		return "capacity_management.CapacityManagementView";
	},
	...
	*/ 
	...
	createContent : function(oController) {
		var oPage = new sap.m.Page(this.createId("SecondPageId"),{
			...
			content:[
			    new sap.ui.commons.Panel(this.createId("LinePanelId"),{
					text:"Report Name/Response Time Line Chart",
					width:"100%",
					height:"350px",
					content:[
					    new sap.viz.ui5.Line({  
					    	id : this.createId("lineChartId"),
					    	width : "80%",
					    	height : "350px",
					    	align:"center",
					    	title : {
			    ...
			    new sap.ui.table.DataTable(this.createId("tableId"),{
			    	title:"Top 50 RFC Reports of Last Week ",			    	
					visibleRowCount: 10,
					editable:false
